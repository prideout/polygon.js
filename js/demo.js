  ...
  Application = (function() {
          ...
          c = [
            {
              ...
              "x": 453.2088886237956,
              "y": 171.44247806269215
            }, {
              "x": 334.7296355333861,
              "y": 103.0384493975584
            }, {
              "x": 200.00000000000006,
              "y": 126.79491924311225
            }, {
              "x": 112.06147584281834,
              "y": 231.59597133486622
            }, {
              "x": 112.06147584281831,
              "y": 368.40402866513375
            }, {
              "x": 199.99999999999991,
              "y": 473.2050807568877
            }, {
              "x": 334.729635533386,
              "y": 496.96155060244166
            }
          ];
          h = [
            {
    ...
    Application.prototype.assignEventHandlers = function() {
      ...
      c.mousemove(function(e) {
        return _this.onMove(e.offsetX, e.offsetY);
      });
      c.mousedown(function(e) {
        _this.onDown(e.offsetX, e.offsetY);
        return e.originalEvent.preventDefault();
      });
      c.mouseup(function(e) {
        return _this.onUp(e.offsetX, e.offsetY);
      });
